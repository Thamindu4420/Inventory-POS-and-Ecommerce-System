...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        echo '<script>window.location.href = "http://localhost/Kumara%20Stores%20Inventory_system/Dashboard/";</script>';
        exit();
    } else {
        // Handle invalid login
        echo '<script>alert("Invalid login credentials. Please try again.");</script>';
        echo '<script>window.location.href = "http://localhost/Kumara%20Stores%20Inventory_system/Login/";</script>';
    }
