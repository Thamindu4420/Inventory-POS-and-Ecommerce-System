function printTable() {
    ...
    if (table) {
      ...
      const headings = table.querySelectorAll('th:nth-child(1), th:nth-child(2), th:nth-child(3), th:nth-child(4)'); 
      ...
      rows.forEach(row => {
        tableContent += '<tr>';
        const columns = row.querySelectorAll('td:nth-child(1), td:nth-child(2), td:nth-child(3), td:nth-child(4)'); 
