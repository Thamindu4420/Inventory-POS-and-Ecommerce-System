function printTable() {
    ...
    if (table) {
      ...
      tableContent += '<h1><img class="logo" src="https://i.ibb.co/jrp6hSp/Screenshot-1183.png" alt="Kumara Stores Logo"><span class="store-text">Kumara Stores</span></h1>'; // Add the logo and text
      tableContent += '<table>';
  
      // Get the table headings (th elements)
      const headings = table.querySelectorAll('th:nth-child(1)'); 
      ...
      rows.forEach(row => {
        tableContent += '<tr>';
        const columns = row.querySelectorAll('td:nth-child(1)'); 
