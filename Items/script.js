function printTable() {
    ...
    if (table) {
      ...
      const headings = table.querySelectorAll('th:nth-child(1), th:nth-child(2)'); // Select the 1st and 2nd columns (Item and Status)
      ...
      rows.forEach(row => {
        tableContent += '<tr>';
        const columns = row.querySelectorAll('td:nth-child(1), td:nth-child(2)'); // Select the 1st and 2nd columns (Item and Status)
